        ...
        <div className="about-features">
          <div className="about-feature-card about-feature-innovation">
            ...
            <div className="about-feature-desc about-feature-desc-justify">
              Профессиональная международная площадка, которая собирает руководителей ведущих предприятий угольной промышленности России и СНГ: генеральных директоров, технических руководителей, инициаторов инвестиционных проектов, представителей правительства, отраслевые регуляторно-надзорные органы, лицензиаров, разработчиков, производителей и поставщиков оборудования и услуг, инжиниринговые и проектно-строительные компании.
            </div>
          </div>
          ...
          <div className="about-feature-card about-feature-innovation">
            ...
            <div className="about-feature-desc about-feature-desc-justify">
              Мероприятие посвящено обмену опытом ключевых компаний угольной индустрии, обсуждению крупнейших инвестиционных проектов строительства и модернизации предприятий и объектов инфраструктуры, освоения новых месторождений, а также возможностей повышения эффективности действующих предприятий отрасли.
            </div>
          </div>
