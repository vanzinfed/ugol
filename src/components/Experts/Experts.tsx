  ...
  const experts = [
    {
      id: 1,
      name: 'Сахамин Миланович Афанасьев',
      description: 'Член Комитета Совета Федерации по федеративному устройству, региональной политике, местному самоуправлению и делам Севера',
      image: '/expert/ex1.jpg'
    },
    {
      id: 2,
      name: 'Максим Викторович Терещенко',
      description: 'Министр промышленности и геологии Республики Саха( Якутия)',
      image: '/expert/ex2.jpg'
    },
    {
      id: 3,
      name: ' Ирина Александровна Ганиева',
      description: 'Директор Научно-образовательного центра мирового уровня «Кузбасс – Донбасс»',
      image: '/expert/ex3.jpg'
    },
    {
      id: 4,
      name: 'Тамара Ивановна Мордасова',
      description: 'Исполнительный директор международного конгресса «Угольная промышленность; инновации, цифровизация и экологическая безопасность»',
    ...
    {
      id: 7,
      name: 'Наталья Альбертовна Винокурова',
      description: 'Президент Ассоциации Женщины в энергетике.  Коммерческий директор ООО «CIL»',
      image: '/expert/na_vinokurova.jpg'
    },
    {
      id: 8,
      name: 'Иван Васильевич Петров',
      description: 'Заведующий кафедрой логистики Факультета экономики и бизнеса Финансового университета горный инженер Д.э.н. Профессор член Академии горных наук',
      image: '/expert/ex888.jpg'
    },
    // {
    //   id: 8,
          ...
          <div className="text-center">
            <h2
              ...
              style={{
                ...
                fontWeight: 800,
                fontSize: 36,
                color: '#1db8ad',   // изменён цвет заголовка
                textAlign: 'center',
                lineHeight: 1.1,
                marginBottom: 16,
              }}
            >
              Эксперты <span style={{ color: '#1db8ad' }}>конгресса</span>
            </h2>
          </div>
            ...
            {visibleExperts.map(expert => (
              <div key={expert.id} className="expert-card">
                ...
                <div className="expert-info">
                  <h3 style={{ color: '#1db8ad' }}>{expert.name}</h3>  {/* цвет заголовка h3 */}
