  ...
  const experts = [
    {
      ...
      description: 'Заместитель председателя Комитета Совета Федерации ФС РФ по федеративному устройству, региональной политике, местному самоуправлению и делам Севера ',
          ...
          <div className="text-center">
            <h2
              ...
              style={{
                ...
                fontWeight: 800,
                fontSize: 36,
                color: '#efaa34',   // изменён цвет заголовка
                textAlign: 'center',
                lineHeight: 1.1,
                marginBottom: 16,
              }}
            >
              Эксперты <span style={{ color: '#efaa34' }}>конгресса</span>
            </h2>
          </div>
            ...
            {visibleExperts.map(expert => (
              <div key={expert.id} className="expert-card">
                ...
                <div className="expert-info">
                  <h3 style={{ color: '#efaa34' }}>{expert.name}</h3>  {/* цвет заголовка h3 */}
